    ...
    >
      <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full p-6 space-y-4">
        ...
        <div className="text-sm text-slate-700 space-y-3">
          <p>
            This tool is provided <strong>for informational and educational purposes only</strong>.
            It is <strong>not financial advice</strong> and must not be used as the basis for any
          ...
          <p>
            ...
            <strong>we make no guarantee of data accuracy, completeness, or currency</strong>.
